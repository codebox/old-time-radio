...
export class WebServer {
    ...
    setupEndpointHandlers() {
        ...
        this.app.get(config.web.paths.search, (req, res) => {
            const exampleSearch = configHelper.getRandomSearchExample(), goodMatchThreshold = config.search.goodMatchThreshold;
        ...
        this.app.get(`${config.web.paths.search}/:searchText`, (req, res) => {
            const searchText = req.params.searchText, exampleSearch = configHelper.getRandomSearchExample(), goodMatchThreshold = config.search.goodMatchThreshold;
        ...
        this.app.get(config.web.paths.api.channel + ':channel', (req, res) => {
            const channelId = req.params.channel, length = Number(req.query.length);
        ...
        this.app.get(config.web.paths.api.generate + ":ids", (req, res) => {
            const ids = req.params.ids.split(',').map(s => Number(s));
            try {
...
//# sourceMappingURL=webServer.mjs.map