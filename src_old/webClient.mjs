...
function buildRequestQueue(config) {
    ...
    function ensureRequestProcessorIsRunning() {
        if (!running) {
            ...
            function processNext() {
                const nextRequestPermittedTs = lastRequestMillis + config.minRequestIntervalMillis, timeUntilNextRequestPermitted = Math.max(0, nextRequestPermittedTs - clock.nowMillis());
                setTimeout(() => {
...
//# sourceMappingURL=webClient.mjs.map