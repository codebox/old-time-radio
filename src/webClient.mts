...
import type {Millis} from "./types.mjs";
    ...
    function ensureRequestProcessorIsRunning(){
        if (!running) {
            ...
            function processNext() {
                const nextRequestPermittedTs = lastRequestMillis + minRequestIntervalMillis as Millis,
...
export class WebClient {
    ...
    constructor(minRequestIntervalMillis: Millis) {
        this.requestQueue = buildRequestQueue(minRequestIntervalMillis);
    }
